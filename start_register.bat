@echo off
chcp 65001 > nul
title Шкільні Завдання (SchoolNet) — Реєстрація користувачів
...
:: 3. Запуск графічного інтерфейсу реєстрації користувачів без консольного вікна
if exist "venv\Scripts\pythonw.exe" (
    start "" "venv\Scripts\pythonw.exe" user_manager.py
) else (
    start "" "venv\Scripts\python.exe" user_manager.py
)
